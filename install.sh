...
#   指定目标: curl -fsSL https://gitee.com/GreatBigM/agent-skill-gen-skill/raw/main/install.sh | bash -s -- --target hermes,claude,zcode,pi
...
install_one() {
    ...
    [ -f "${TMP}/repo/SCHEMA.md" ] && cp "${TMP}/repo/SCHEMA.md" "${dest}/"
